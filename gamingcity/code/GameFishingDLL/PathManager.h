...
class PathManager : public Singleton<PathManager> {
 public:
  ...
  friend class std::shared_ptr<PathManager>;

 public:
  bool LoadNormalPath(lua_State* L);
  ...
  void CreatePathByData(SPATH* sp, bool xMirror, bool yMirror, bool xyMirror,
                        bool Not, bool troop, MovePoints& out);
