...
function fivestar_table:SendServerStatus( player )
    ...
    log.info(string.format("status [%d] left_time [%d]" , self.status , l_time))
...
function fivestar_table:load_lua_cfg()
    ...
    if fivestar_config then
        ...
        -- 显示玩家数量
        if fivestar_config.show_player_list_max then
            self.show_player_list_max = fivestar_config.show_player_list_max
        end
        ...
        -- 显示幸运星玩家数量
        if fivestar_config.show_luck_player_list_max then
            self.show_luck_player_list_max = fivestar_config.show_luck_player_list_max
        end
        -- 大赢家阀值
        ...
        self:log.error_msg("fivestar_config is nil")
    end

    self:log_important(string.format([[
        fivestar_time_start_countdown [%d] fivestar_time_betting_countdown[%d] fivestar_time_settlement_countdown[%d] history_max[%d] bet_limit[%d] bet_max[%d] bet_all_max[%d] logLevel[%d] show_player_list_max[%d]
        ...
        big_win_limit[%d] , big_win_history_max[%d] , grand_base[%d] ,show_luck_player_list_max[%d] ,luck_count_num [%d]
        ...
        , self.fivestar_time_start_countdown , self.fivestar_time_betting_countdown , self.fivestar_time_settlement_countdown , self.history_max , self.bet_limit , self.bet_max , self.bet_all_max , self.logLevel , self.show_player_list_max,
        ...
        self.big_win_limit , self.big_win_history_max , self.grand_base, self.show_luck_player_list_max,self.luck_count_num,
...
function fivestar_table:check_player_num()
    self:log_msg(string.format("fivestar_table:check_player_num androidNO [%d] #self.player_list_[%d]  self.robot_threshold.playerless[%d]" , getNum(self.android_list) , getNum(self.player_list_) ,  self.robot_threshold.playerless))
    -- body
