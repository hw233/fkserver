...
function fishing_table:load_lua_cfg( ... )
	...
	self.cpp_table:UpdateConfig(self.room_.cell_score_,self.room_.tax_,self.room_.tax_show_)
...
function fishing_table:player_sit_down(player, chair_id_)
	...
	log.info(str)
	redisopt[0].incr(string.format("%s_%d_%d_players",def_game_name,def_first_game_type,def_second_game_type))
...
function fishing_table:player_stand_up(player, is_offline)
	...
	log.info(str)
	redisopt[0].decr(string.format("%s_%d_%d_players",def_game_name,def_first_game_type,def_second_game_type))
