...
function redblack_table:load_lua_cfg()
	...
	log.info(string.format("redblack_table: game_maintain_is_open = [%d]",self.room_.game_switch_is_open))
...
function redblack_table:game_start()
	...
	for k,v in pairs(self.player_win_record) do
		for _,player in pairs(self.player_list_) do
