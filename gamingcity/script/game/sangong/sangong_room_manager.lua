...
require "game.sangong.sangong_table"
...
sangong_room = base_room

-- 初始化房间
function sangong_room:init(tb, chair_count, ready_mode, room_lua_cfg)
	base_room.init(self, tb, chair_count,ready_mode,room_lua_cfg)
end

-- 创建桌子
function sangong_room:create_table()
	return sangong_table:new()
end

-- 坐下处理
function sangong_room:on_sit_down(player)
...
-- 快速坐下
function sangong_room:auto_sit_down(player)
	print "sangong ox auto sit down ....................."
...
-- 坐下
function sangong_room:sit_down(player, table_id_, chair_id_)
	print "sangong sit down ....................."
...
-- 站起
--function sangong_room:stand_up(player)
--	print "sangong stand up ....................."
--
--	local tb = self:find_table_by_player(player)
--	if tb then
--		local chat = {
...
-- 玩家掉线
--[[function sangong_room:player_offline(player)
...
-- 站起并离开房间
function sangong_room:stand_up_and_exit_room(player)
	print("sangong_room:stand_up_and_exit_room=============================")
	...
	if tb:is_play() and tb:in_sangong(player) then
