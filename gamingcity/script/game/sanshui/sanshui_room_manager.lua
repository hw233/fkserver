...
require "game.sanshui.sanshui_table"
...
sanshui_room = class("sanshui_room",base_room)

function sanshui_room:ctor( ... )
    
end


function sanshui_room:init(tb, chair_count, ready_mode,room_lua_cfg)
...
function sanshui_room:update_lua_cfg( room_lua_cfg )
    -- log.warning(string.format("sanshui_table:load_lua_cfg,%s",room_lua_cfg))
