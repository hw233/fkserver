...
function showhand_table:add_score(player, msg)
	if msg then
		if msg.round_index == self.cur_game_round then
			...
			log.info(string.format("add_score error round->%d cur_game_round->%d",msg.round_index,self.cur_game_round))
		end
    end
end
-- 弃牌
...
function showhand_table:pass(player,msg)
	if msg then
		if msg.round_index == self.cur_game_round then
			...
			log.info(string.format("pass error round->%d cur_game_round->%d",msg.round_index,self.cur_game_round))
		end
    end
end
--give_up_eixt
