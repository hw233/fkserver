...
slotma_room = base_room

-- 初始化房间
function slotma_room:init(tb, chair_count, ready_mode,room_lua_cfg)
	base_room.init(self, tb, chair_count, ready_mode,room_lua_cfg)
end

-- 创建桌子
function slotma_room:create_table()
	return slotma_table:new()
end

-- 坐下处理
function slotma_room:on_sit_down(player)
	print("slotma_room:on_sit_down")
end

-- 快速坐下
function slotma_room:auto_sit_down(player)
	print("slotma_room:auto_sit_down .....................")
...
function slotma_room:get_table_players_status( player )
...
-- 坐下
function slotma_room:sit_down(player, table_id_, chair_id_)
	print "slotma_room:sit_down ....................."
...
-- 站起
function slotma_room:stand_up(player)
	print "slotma_room:stand_up ....................."
	return base_room.stand_up(self, player)
end

function slotma_room:tick()
