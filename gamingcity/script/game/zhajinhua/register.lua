...
register_client_dispatcher("CS_ZhaJinHuaShowCards",on_cs_zhajinhua_show_cards)
register_client_dispatcher("CS_ZhaJinHuaLastRecord",on_CS_ZhaJinHuaLastRecord)
register_client_dispatcher("CS_ZhaJinHuaBonusPool",on_CS_ZhaJinHuaBonusPool)