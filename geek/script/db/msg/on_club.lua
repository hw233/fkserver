...
function on_sd_join_club(msg)
    ...
    local sqls = {
        string.format([[INSERT INTO t_club_member(club,guid) VALUES(%d,%d) ON DUPLICATE KEY IGNORE;]],club_id,guid),
        string.format([[INSERT INTO t_player_money(guid,money_id,money,`where`) VALUES(%d,%d,0,0) ON DUPLICATE KEY IGNORE;]],guid,money_id),
    }
