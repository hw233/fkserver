...
register_dispatcher("SD_LogPlayerCommissionContribute",on_sd_log_player_commission_contribute)
register_dispatcher("SD_UpdatePlayerInfo",on_sd_update_player_info)
register_dispatcher("SD_LogExtGameRoundStart",on_sd_log_ext_game_round_start)
register_dispatcher("SD_LogExtGameRoundEnd",on_sd_log_ext_game_round_end)
register_dispatcher("SD_LogExtGameRoundPlayerJoin",on_sd_log_ext_game_round_player_join)