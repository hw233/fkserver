...
define.FSM_state = {
	...
	WAIT_ACTION_AFTER_FIRSTFIRST_TOU_PAI  	= pb.enum("FSM_STATE","WAIT_ACTION_AFTER_FIRSTFIRST_TOU_PAI"),	--等待偷牌
	WAIT_ACTION_AFTER_TIAN_HU = pb.enum("FSM_STATE","WAIT_ACTION_AFTER_TIAN_HU"),	--等待天胡
	WAIT_ACTION_AFTER_JIN_PAI  	= pb.enum("FSM_STATE","WAIT_ACTION_AFTER_JIN_PAI"),	--等待进牌
	WAIT_ACTION_AFTER_FAN_PAI  	= pb.enum("FSM_STATE","WAIT_ACTION_AFTER_FAN_PAI"),	--等待 胡, 用户巴杠的时候，抢胡
	...
	TOU_PAI						= pb.enum("FSM_STATE","TOU_PAI"),	--偷牌
	FAN_PAI						= pb.enum("FSM_STATE","FAN_PAI"),	--翻牌
