...
local MAIL_OPT_RESULT_SUCCESS = pb.enum("MAIL_OPT_RESULT", "MAIL_OPT_RESULT_SUCCESS")
local MAIL_OPT_RESULT_FIND_FAILED = pb.enum("MAIL_OPT_RESULT", "MAIL_OPT_RESULT_FIND_FAILED")
local MAIL_OPT_RESULT_EXPIRATION = pb.enum("MAIL_OPT_RESULT", "MAIL_OPT_RESULT_EXPIRATION")
local MAIL_OPT_RESULT_NO_ATTACHMENT = pb.enum("MAIL_OPT_RESULT", "MAIL_OPT_RESULT_NO_ATTACHMENT")
local MAIL_OPT_RESULT_HAS_ATTACHMENT = pb.enum("MAIL_OPT_RESULT", "MAIL_OPT_RESULT_HAS_ATTACHMENT")
...
function on_des_send_mail_from_center(msg)
	...
	local player = base_players[mail_.guid]
	if player then
