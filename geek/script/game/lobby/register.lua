...
skynet.start(function()
	...
	register_dispatcher("DES_SendMail",on_des_send_mail)
	...
	register_dispatcher("C2S_JOIN_ROOM_REQ",on_cs_join_private_room)
	register_dispatcher("C2S_ROOM_CREATE_REQ",on_cs_create_private_room)
	...
	register_dispatcher("CS_ReceiveMailAttachment",on_cs_receive_mail_attachment)
	register_dispatcher("CS_ReceiveRewardLogin",on_cs_receive_reward_login)
	register_dispatcher("CS_ReceiveRewardOnline",on_cs_receive_reward_online)
	register_dispatcher("CS_ReceiveReliefPayment",on_cs_receive_relief_payment)
