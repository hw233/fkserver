...
local HU_TYPE_INFO = {
	...
	[HU_TYPE.SI_GUI_YI]				= {name = "SI_GUI_YI",score = 0,fan = 1},				--四归一
	...
	[HU_TYPE.BAO_TING]				= {name = "BAO_TING",score = 0,fan = 1},				--报听
	...
	[HU_TYPE.DA_DUI_ZI]  			= {name = "DA_DUI_ZI",score = 0,fan = 2},				--大对子
	...
	[HU_TYPE.SHA_BAO]				= {name = "SHA_BAO",score = 0,fan = 1},		--杀报
	...
	[HU_TYPE.JIANG_DUI]				= {name = "JIANG_DUI",fan = 0,score = 0,},	--将对
	[HU_TYPE.JIANG_QI_DUI]			= {name = "JIANG_QI_DUI",fan = 0,score = 0,},	--将七对
	[HU_TYPE.QUAN_YAO_JIU]			= {name = "QUAN_YAO_JIU",fan = 0,score = 0},	--全幺九
	[HU_TYPE.DAI_GOU]				= {name = "DAI_GOU",fan = 1,score = 0},	--带根
	[HU_TYPE.KA_WU_XING]			= {name = "KA_WU_XING",fan = 0,score = 0}, --卡五星
	...
	[HU_TYPE.RUAN_AN_GANG]			= {name = "RUAN_AN_GANG",fan = 1,score = 2}, --软暗杠
	[HU_TYPE.RUAN_MING_GANG]		= {name = "RUAN_MING_GANG",fan = 1,score = 2}, --软明杠
	[HU_TYPE.RUAN_BA_GANG]			= {name = "RUAN_BA_GANG",fan = 1,score = 1}, --软吧杠
	[HU_TYPE.WU_JI]					= {name = "WU_JI",fan = 1,score = 0}, --无鸡
	[HU_TYPE.SI_JI]					= {name = "SI_JI",fan = 10,score = 0}, --四鸡顶翻
