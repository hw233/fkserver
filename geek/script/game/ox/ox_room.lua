...
local ox_table = require "game.ox.ox_table"
...
local ox_room = base_room:new()

-- 初始化房间
function ox_room:init(tb, chair_count, ready_mode)
...
-- 坐下处理
function ox_room:on_sit_down(player)
...
-- 快速坐下
function ox_room:auto_sit_down(player)
...
-- 坐下
function ox_room:sit_down(player, table_id_, chair_id_)
...
-- 站起
function ox_room:stand_up(player)
...
-- 获取本房间的所有玩家信息
function ox_room:get_top_info(player)
