...
local shelongmen_table = require "game.shelongmen.shelongmen_table"
...
local shelongmen_room = base_room:new()
...
function shelongmen_room:update_lua_cfg( room_lua_cfg )
	log.warning("shelongmen_room:load_lua_cfg,%s",room_lua_cfg)
