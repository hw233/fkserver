...
-- ACT_BET 					= pb.enum("TexasAction","ACT_BET")  				--0x000001 --押注
-- ACT_CALL 					= pb.enum("TexasAction","ACT_CALL")  			--0x000010 --跟注
-- ACT_RAISE 					= pb.enum("TexasAction","ACT_RAISE")  			--0x000100 --加注
-- ACT_CHECK 					= pb.enum("TexasAction","ACT_CHECK")  			--0x001000 --让牌
-- ACT_FOLD 					= pb.enum("TexasAction","ACT_FOLD")  			--0x010000 --弃牌
-- ACT_ALL						= pb.enum("TexasAction","ACT_ALL")				--0x100000 --全下

--扑克类型
CT_HIGH_CARD		= pb.enum("TexasCardsType","CT_HIGH_CARD")			--1  单牌类型
CT_ONE_PAIR			= pb.enum("TexasCardsType","CT_ONE_PAIR")			--2  对子类型
CT_TWO_PAIRS		= pb.enum("TexasCardsType","CT_TWO_PAIRS")			--3  两对类型
CT_THREE_OF_A_KIND	= pb.enum("TexasCardsType","CT_THREE_OF_A_KIND")		--4  三条类型
CT_STRAIGHT			= pb.enum("TexasCardsType","CT_STRAIGHT")			--5  顺子类型
CT_FLUSH			= pb.enum("TexasCardsType","CT_FLUSH")				--6  同花类型
CT_FULL_HOUSE		= pb.enum("TexasCardsType","CT_FULL_HOUSE")			--7  葫芦类型
CT_FOUR_OF_KIND		= pb.enum("TexasCardsType","CT_FOUR_OF_KIND")		--8  铁支类型
CT_STRAIT_FLUSH		= pb.enum("TexasCardsType","CT_STRAIT_FLUSH")		--9  同花顺型
CT_ROYAL_FLUSH		= pb.enum("TexasCardsType","CT_ROYAL_FLUSH")			--10 皇家同花顺
