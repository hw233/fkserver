...
local twenty_one_table = require "game.twenty_one.twenty_one_table"
...
local twenty_one_room = base_room:new()

function twenty_one_room:init(conf, chair_count, ready_mode)
...
function twenty_one_room:update_lua_cfg( room_lua_cfg )
    log.info("twenty_one_room:load_lua_cfg,%s",room_lua_cfg)
