...
function on_cs_zhajinhua_give_up(player, msg)
	log.info("on_cs_zhajinhua_give_up guid[%d]",player.guid)
...
function on_cs_zhajinhua_compare_card(player, msg)
	...
	if tb then
		...
		if msg.compare_chair_id then
			...
			log.error("guid[%d] compare card  no chair id", player.guid)
		end
	else
...
function on_cs_zhajinhua_get_player_status(player, msg)
	...
	if tb then
		...
		log.error("guid[%d] get_player_status", player.guid)
	end
end
...
function on_CS_ZhaJinHuaBonusPool(player, msg)
	...
	if tb then
		...
		log.error("guid[%d] on_CS_ZhaJinHuaBonusPool", player.guid)
	end
end