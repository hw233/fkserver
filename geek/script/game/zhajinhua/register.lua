...
register_dispatcher("CS_ZhaJinHuaCompareCard",on_cs_zhajinhua_compare_card)
register_dispatcher("CS_ZhaJinHuaGetPlayerStatus",on_cs_zhajinhua_get_player_status)
register_dispatcher("CS_ZhaJinHuaGetSitDown",on_cs_zhajinhua_get_sit_down)
...
register_dispatcher("CS_ZhaJinHuaBonusPool",on_CS_ZhaJinHuaBonusPool)