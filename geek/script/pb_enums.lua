...
local enums = {
    ...
    GAME_SERVER_RESULT_WAIT_LATER = pb.enum("GAME_SERVER_RESULT", "GAME_SERVER_RESULT_WAIT_LATER"),
    ...
    LOGIN_RESULT_ACCOUNT_NOT_EXISTS = pb.enum("LOGIN_RESULT","LOGIN_RESULT_ACCOUNT_NOT_EXISTS"),
    LOGIN_RESULT_IP_CREATE_ACCOUNT_LIMIT = pb.enum("LOGIN_RESULT","LOGIN_RESULT_IP_CREATE_ACCOUNT_LIMIT"),
    LOGIN_RESULT_ACCOUNT_IP_LIMIT = pb.enum("LOGIN_RESULT","LOGIN_RESULT_ACCOUNT_IP_LIMIT"),
    LOGIN_RESULT_ACCOUNT_IMEI_LIMIT = pb.enum("LOGIN_RESULT","LOGIN_RESULT_ACCOUNT_IMEI_LIMIT"),
    LOGIN_RESULT_ACCOUNT_PASSWOLD_ERRPR_LIMIT = pb.enum("LOGIN_RESULT","LOGIN_RESULT_ACCOUNT_PASSWOLD_ERRPR_LIMIT"),
    ...
    LOG_MONEY_OPT_TYPE_OX_DIANZI = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_OX_DIANZI"),
    ...
    LOG_MONEY_OPT_TYPE_MAAJAN_MENHU = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_MENHU"),
    ...
    LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_ER_YI = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_ER_YI"),
    LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_ER_ER = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_ER_ER"),
    LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_ER_SAN  = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_ER_SAN"),
    LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_SAN_ER = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_SAN_ER"),
    LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_SI_ER = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_XUEZHAN_SI_ER"),
    LOG_MONEY_OPT_TYPE_PDK_ER_REN = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_PDK_ER_REN"),
    LOG_MONEY_OPT_TYPE_PDK_SC = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_PDK_SC"),
    LOG_MONEY_OPT_TYPE_AUTO_CLUB_COMMISSION = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_AUTO_CLUB_COMMISSION"),
    LOG_MONEY_OPT_TYPE_MAAJAN_YAOJI = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_YAOJI"), 
    
    LOG_MONEY_OPT_TYPE_MAAJAN_HONGZHONG = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_HONGZHONG"),
    LOG_MONEY_OPT_TYPE_MAAJAN_ZIGONG = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_ZIGONG"),
    LOG_MONEY_OPT_TYPE_CHANGPAI_ZIGONG = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_CHANGPAI_ZIGONG"),
    LOG_MONEY_OPT_TYPE_MAAJAN_NANCHONG = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_NANCHONG"),
    LOG_MONEY_OPT_TYPE_MAAJAN_ZIGONGHUA_LIANGFU = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_ZIGONGHUA_LIANGFU"),
    LOG_MONEY_OPT_TYPE_MAAJAN_ZIGONGHUA_SANFUBAN = pb.enum("LOG_MONEY_OPT_TYPE","LOG_MONEY_OPT_TYPE_MAAJAN_ZIGONGHUA_SANFUBAN"),
    ...
    ERROR_CLUB_TEAM_IS_LOCKED = pb.enum("ERROR_CODE", "ERROR_CLUB_TEAM_IS_LOCKED"),
    ERROR_BLOCK_GAMING = pb.enum("ERROR_CODE", "ERROR_BLOCK_GAMING"),
    ERROR_CLUB_BLOCK = pb.enum("ERROR_CODE", "ERROR_CLUB_BLOCK"),
    ERROR_CLUB_CLOSE = pb.enum("ERROR_CODE", "ERROR_CLUB_CLOSE"),
    ERROR_BLOCK_JOIN_WHEN_GAMING = pb.enum("ERROR_CODE","ERROR_BLOCK_JOIN_WHEN_GAMING"),
    ERROR_LESS_READY_PLAYER = pb.enum("ERROR_CODE","ERROR_LESS_READY_PLAYER"),
    ERROR_CLUB_TEAM_CLOSE = pb.enum("ERROR_CODE","ERROR_CLUB_TEAM_CLOSE"),
    ERROR_CLUB_TEAM_NOT_CLOSED = pb.enum("ERROR_CODE","ERROR_CLUB_TEAM_NOT_CLOSED"),
    ERROR_CLUB_SIZE_LIMIT = pb.enum("ERROR_CODE","ERROR_CLUB_SIZE_LIMIT"),
    ...
    STANDUP_REASON_ADMIN_DISMISS_FORCE = pb.enum("STANDUP_REASON","STANDUP_REASON_ADMIN_DISMISS_FORCE"),
    STANDUP_REASON_DISMISS_REQUEST = pb.enum("STANDUP_REASON","STANDUP_REASON_DISMISS_REQUEST"),
    STANDUP_REASON_DISMISS_TRUSTEE = pb.enum("STANDUP_REASON","STANDUP_REASON_DISMISS_TRUSTEE"),
    STANDUP_REASON_BANKRUPCY = pb.enum("STANDUP_REASON","STANDUP_REASON_BANKRUPCY"),
    STANDUP_REASON_TABLE_TIMEOUT = pb.enum("STANDUP_REASON","STANDUP_REASON_TABLE_TIMEOUT"),
    STANDUP_REASON_NO_READY_TIMEOUT = pb.enum("STANDUP_REASON","STANDUP_REASON_NO_READY_TIMEOUT"),
    STANDUP_REASON_MAINTAIN = pb.enum("STANDUP_REASON","STANDUP_REASON_MAINTAIN"),
    STANDUP_REASON_ROUND_END = pb.enum("STANDUP_REASON","STANDUP_REASON_ROUND_END"),
    STANDUP_REASON_BLOCK_GAMING = pb.enum("STANDUP_REASON","STANDUP_REASON_BLOCK_GAMING"),
    STANDUP_REASON_CLUB_CLOSE = pb.enum("STANDUP_REASON", "STANDUP_REASON_CLUB_CLOSE"),
    STANDUP_REASON_DELAY_KICKOUT_TIMEOUT = pb.enum("STANDUP_REASON","STANDUP_REASON_DELAY_KICKOUT_TIMEOUT"),
    STANDUP_REASON_LESS_ROOM_FEE = pb.enum("STANDUP_REASON","STANDUP_REASON_LESS_ROOM_FEE"),

    DISMISS_REASON_NORMAL = pb.enum("DISMISS_REASON","DISMISS_REASON_NORMAL"),
    DISMISS_REASON_REQUEST = pb.enum("DISMISS_REASON","DISMISS_REASON_REQUEST"),
    DISMISS_REASON_ADMIN_FORCE = pb.enum("DISMISS_REASON","DISMISS_REASON_ADMIN_FORCE"),
    DISMISS_REASON_BANKRUPCY = pb.enum("DISMISS_REASON","DISMISS_REASON_BANKRUPCY"),
    DISMISS_REASON_TRUSTEE_AUTO = pb.enum("DISMISS_REASON","DISMISS_REASON_TRUSTEE_AUTO"),
    DISMISS_REASON_TIMEOUT = pb.enum("DISMISS_REASON","DISMISS_REASON_TIMEOUT"),
    DISMISS_REASON_MAINTAIN = pb.enum("DISMISS_REASON","DISMISS_REASON_MAINTAIN"),
    DISMISS_REASON_ROUND_END = pb.enum("DISMISS_REASON","DISMISS_REASON_ROUND_END"),
    DISMISS_REASON_LESS_ROOM_FEE = pb.enum("DISMISS_REASON","DISMISS_REASON_LESS_ROOM_FEE"),


    ANTI_CHEAT_DESKMATE = pb.enum("ANTI_CHEAT_TYPE","ANTI_CHEAT_DESKMATE"),
    ANTI_CHEAT_PINGHU = pb.enum("ANTI_CHEAT_TYPE","ANTI_CHEAT_PINGHU"),
    ANTI_CHEAT_PENGGANG = pb.enum("ANTI_CHEAT_TYPE","ANTI_CHEAT_PENGGANG"),
    ...
    CLUB_ACTION_JOIN = pb.enum("CLUB_ACTION_TYPE","CLUB_ACTION_JOIN"),
    CLUB_ACTION_EXIT = pb.enum("CLUB_ACTION_TYPE","CLUB_ACTION_EXIT"),
    CLUB_ACTION_CREATE_PARTNER = pb.enum("CLUB_ACTION_TYPE","CLUB_ACTION_CREATE_PARTNER"),
    CLUB_ACTION_DISMISS_PARTNER = pb.enum("CLUB_ACTION_TYPE","CLUB_ACTION_DISMISS_PARTNER"),


    -- enum RECEIVE_REWARD_RESULT
    RECEIVE_REWARD_RESULT_SUCCESS = pb.enum("RECEIVE_REWARD_RESULT", "RECEIVE_REWARD_RESULT_SUCCESS"),
    RECEIVE_REWARD_RESULT_ERR_MONEY = pb.enum("RECEIVE_REWARD_RESULT", "RECEIVE_REWARD_RESULT_ERR_MONEY"),
    RECEIVE_REWARD_RESULT_ERR_REPEATED = pb.enum("RECEIVE_REWARD_RESULT", "RECEIVE_REWARD_RESULT_ERR_REPEATED"),
    RECEIVE_REWARD_RESULT_ERR_FIND_LOGIN_AWARD = pb.enum("RECEIVE_REWARD_RESULT", "RECEIVE_REWARD_RESULT_ERR_FIND_LOGIN_AWARD"),
    RECEIVE_REWARD_RESULT_ERR_FIND_ONLINE_AWARD = pb.enum("RECEIVE_REWARD_RESULT", "RECEIVE_REWARD_RESULT_ERR_FIND_ONLINE_AWARD"),
    RECEIVE_REWARD_RESULT_ERR_ONLINE_AWARD_CD = pb.enum("RECEIVE_REWARD_RESULT", "RECEIVE_REWARD_RESULT_ERR_ONLINE_AWARD_CD"),
    RECEIVE_REWARD_RESULT_ERR_COUNT_LIMIT = pb.enum("RECEIVE_REWARD_RESULT", "RECEIVE_REWARD_RESULT_ERR_COUNT_LIMIT"),
    RECEIVE_REWARD_RESULT_ERR_MONEY_LIMIT = pb.enum("RECEIVE_REWARD_RESULT", "RECEIVE_REWARD_RESULT_ERR_MONEY_LIMIT"),

    -- enum ITEM_OPERATE_RESULT 
    ITEM_OPERATE_RESULT_SUCCESS = pb.enum("ITEM_OPERATE_RESULT", "ITEM_OPERATE_RESULT_SUCCESS"),
    ITEM_OPERATE_RESULT_ITEMID_ERR = pb.enum("ITEM_OPERATE_RESULT", "ITEM_OPERATE_RESULT_ITEMID_ERR"),
    ITEM_OPERATE_RESULT_NUM_ERR = pb.enum("ITEM_OPERATE_RESULT", "ITEM_OPERATE_RESULT_NUM_ERR"),
    ITEM_OPERATE_RESULT_MONEY_NOT_ENOUGH = pb.enum("ITEM_OPERATE_RESULT", "ITEM_OPERATE_RESULT_MONEY_NOT_ENOUGH"),
    ITEM_OPERATE_RESULT_DEL_FAILED = pb.enum("ITEM_OPERATE_RESULT", "ITEM_OPERATE_RESULT_DEL_FAILED"),
    ITEM_OPERATE_RESULT_USE_FAILED = pb.enum("ITEM_OPERATE_RESULT", "ITEM_OPERATE_RESULT_USE_FAILED"),

    ERS_NONE = pb.enum("EXT_ROUND_STATUS","ERS_NONE"),
    ...
    NW_GAME = pb.enum("NOTICE_WHERE","GAME"),

    NT_NIL = pb.enum("NOTICE_TYPE","NT_NIL"),

    CLUB_STATUS_NORMAL = pb.enum("CLUB_STATUS","CLUB_STATUS_NORMAL"),
    CLUB_STATUS_CLOSE = pb.enum("CLUB_STATUS","CLUB_STATUS_CLOSE"),
    CLUB_STATUS_BLOCK = pb.enum("CLUB_STATUS","CLUB_STATUS_BLOCK"),

    REDDOT_TYPE_MAIL = pb.enum("REDDOT_TYPE","REDDOT_TYPE_MAIL"),
    REDDOT_TYPE_REQUEST_CLUB = pb.enum("REDDOT_TYPE","REDDOT_TYPE_REQUEST_CLUB"),
    REDDOT_TYPE_REQUEST_PLAYER = pb.enum("REDDOT_TYPE","REDDOT_TYPE_REQUEST_PLAYER"),

    TSO_NIL = pb.enum("TABLE_SYNC_OPCODE","TSO_NIL"),
    TSO_CREATE = pb.enum("TABLE_SYNC_OPCODE","TSO_CREATE"),
	TSO_DELETE = pb.enum("TABLE_SYNC_OPCODE","TSO_DELETE"),
	TSO_JOIN = pb.enum("TABLE_SYNC_OPCODE","TSO_JOIN"),
