...
local enums = {
    ...
    ERROR_JOIN_ROOM_NON_IP_TREAT_ROOM = pb.enum("ERROR_CODE","ERROR_JOIN_ROOM_NON_IP_TREAT_ROOM"),
    ERROR_JOIN_ROOM_NON_GPS_TREAT_ROOM = pb.enum("ERROR_CODE","ERROR_JOIN_ROOM_NON_GPS_TREAT_ROOM"),
