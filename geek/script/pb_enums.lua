...
local enums = {
    ...
    ERROR_CLUB_UNKONW = pb.enum("ERROR_CODE","ERROR_CLUB_UNKONW"),
    ...
    ERROR_ZJH_ROOM_DISCARD_REPEAT = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISCARD_REPEAT"),
    ERROR_ZJH_ROOM_DISCARD_GAMESTARTED = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISCARD_GAMESTARTED"),
    ERROR_ZJH_ROOM_DISCARD_SEECARD = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISCARD_SEECARD"),
    ERROR_ZJH_ROOM_DISCARD_VERSUSCARD_REPEATVERSYS = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISCARD_VERSUSCARD_REPEATVERSYS"),
    ERROR_ZJH_ROOM_DISCARD_VERSUSCARD_REPEAT = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISCARD_VERSUSCARD_REPEAT"),
    ERROR_ZJH_ROOM_DISCARD_VERSUSCARD_ISLOCK = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISCARD_VERSUSCARD_ISLOCK"),
    ERROR_ZJH_ROOM_DISCARD_ADDBET_REPEAT = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISCARD_ADDBET_REPEAT"),
    ERROR_ZJH_ROOM_DISCARD_FOLLOWBET_REPEAT = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISCARD_FOLLOWBET_REPEAT"),
    ERROR_ZJH_ROOM_DISMIS_NO = pb.enum("ERROR_CODE","ERROR_ZJH_ROOM_DISMIS_NO"),
